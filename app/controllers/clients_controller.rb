...
private
  ...
  def client_params
    params.require(:client).permit(:picture, :username, :name, :surname, :email, :password, :street, :city, :code, :password_confirmation, :favourite_hairstyles, :favourite_products, :favourites_gallery, :favourite_stylists, :nickname)
  end
